...
return {
  ...
  keys = {
    ...
    { mode = "v", "S", "<Plug>(nvim-surround-visual)", desc = "Surround the selection (via nvim-surround)" },
    { mode = "v", "gS", "<Plug>(nvim-surround-visual-line)", desc = "Surround the selection, place surrounding on new lines (via nvim-surround)" },
